...
Page({
    ...
    onLoad: function (options) {
        let that = this;
        util.syncUserInfo(function(res,data,info){
          that.userinfo=res;
        });
        that.setData({
            options: options
    ...
    mywordinit: function (options) {
        ...
        requestUtil.post(_DuoguanData.duoguan_host_api_url + '/index.php?s=/addon/MarketingWord/IndexApi/wordIndex.html', options, (info) => {
            that.setData({
                ...
                that.title = that.data.wordcon.share_title;
                util.syncUserInfo(function (userinfo, data, osInfo) {
                    let uid = userinfo.uid;
                    let url = 'pages/plug-in/collectWord/index/index?userid=' + uid;
