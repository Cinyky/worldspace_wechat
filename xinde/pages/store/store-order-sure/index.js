...
Page({
  ...
  getGoodsInfo: function() {
    var that = this;
    requestUtil.get(_DgData.duoguan_host_api_url + '/index.php?s=/addon/DgStore/Api/getGoodsInfo.html', {
      store_id: that.data.this_store_id,
  ...
  order_formSubmit: function(e) {
    ...
    if (that.data.order_type == 1) {
      ...
      //保存配送费到订单信息
      var order_free = that.data.store_info.waimai_peisong_jiner
      order_info.shipping_fee = order_free ? order_free : 0
    }
    that.setData({
  ...
  getStoreInfo: function() {
    var that = this;
    requestUtil.get(_DgData.duoguan_host_api_url + '/index.php?s=/addon/DgStore/StoreApi/getStoreInfo.html', {
      store_id: that.data.this_store_id
    }, (data) => {
  ...
  getCartList: function() {
    var that = this;
    requestUtil.get(_DgData.duoguan_host_api_url + "/index.php?s=/addon/DgStore/StoreApi/getShopCart", {
      store_id: that.data.this_store_id
    }, (data) => {
      var that = this;
  ...
  getmycard: function() {
    var that = this;
    requestUtil.get(_DgData.duoguan_host_api_url + "/index.php?s=/addon/DgStore/StoreApi/getMyCoupons.html", {
      available: 1,
      _r: 100,
      store_id: that.data.this_store_id
    }, (data) => {
