...
Page({
    ...
    onLoad: function (options) {
      ...
      var user_id = options.user_id;
        ...
        server.getJSON('/User/getgoodsInfo/id/' + order_id + '/goods_id/' + goods_id + '/user_id/' + user_id, function (res) {
            ...
            function _submit() {
                ...
                wx.request({
                    ...
                    data: {
                        ...
                        goods_id: page.data.goods.goods_list.goods_id,
                        reason: desc,
                        imgs: JSON.stringify(pic_url_list),
                    },
                    success: function (res) {
                            ...
                            wx.showModal({
                                ...
                                success: function (res) {
                                    if (res.confirm) {
                                        ...
                                        wx.redirectTo({
                                            url: "/pages/order/list/list?index=5"
                                        });
                                    }
                                }
                            });
